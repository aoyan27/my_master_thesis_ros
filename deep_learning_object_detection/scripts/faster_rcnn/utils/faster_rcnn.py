...
from utils.proposal_target_layer import ProposalTargetLayer
    ...
    def __call__(self, x, img_info, gt_boxes=None):
        ...
        with cuda.get_device_from_array(x.data):
            ...
            pool5 = F.roi_pooling_2d(feature_map, brois, 7, 7,
                                     self._spatial_scale)
            with chainer.using_config('train', self.rcnn_train):
                fc6 = F.dropout(F.relu(self.fc6(pool5)))
                fc7 = F.dropout(F.relu(self.fc7(fc6)))
