...
Calibration6DoF calibration(bool doRefinement = false){
	...
	cout<<"radius2D : "<<radius2D<<endl;
	cout<<"centers2D : "<<centers2D<<endl;
...
void callback(const sensor_msgs::ImageConstPtr& msg_img, const sensor_msgs::CameraInfoConstPtr& msg_info, const sensor_msgs::PointCloud2ConstPtr& msg_pc){
...
int main(int argc, char** argv){
	...
	namedWindow("edge_image");
	namedWindow("hough_image");
	startWindowThread();
